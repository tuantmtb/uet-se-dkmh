			...
			<c:forEach var="course" items="${courses}">
				<tr>
					...
					<td>
						...
						<button class="btn btn-info" onclick="location.href='${courseUrl}'">Xem</button>
						<button class="btn btn-primary" onclick="location.href='${updateUrl}'">Sửa</button>
						<button class="btn btn-danger" onclick="this.disabled=true;post('${deleteUrl}')">Xóa</button></td>
				</tr>
			</c:forEach>
		</table>
